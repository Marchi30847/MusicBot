...
@pytest.mark.unit
class TestEnqueueMapper:
    def test_title_falls_back_to_url_when_missing(
        self, make_enqueue_command: MakeEnqueueCommand
    ) -> None:
    ...
    def test_title_is_used_when_provided(self, make_enqueue_command: MakeEnqueueCommand) -> None:
        url: str = "https://example.com/a.mp3"
        title: str = "My Track"
        cmd: EnqueueCommand = make_enqueue_command(
